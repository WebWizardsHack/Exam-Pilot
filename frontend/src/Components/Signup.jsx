         ...
         <div className='m-auto   md:w-[32rem] w-full rounded-md shadow-md'>
              ...
              <form className='px-6' onSubmit={setData}>
                  <div className='flex flex-col mt-4'>
                      ...
                      <input required type="text" className=' border-b-2 outline-none px-2 my-2 focus:border-gray-500' name='name' placeholder='Your name' onChange={getdata} />
                  </div>
                  <div className='flex flex-col mt-4'>
                      <label htmlFor="username" className=' font-semibold text-lg'>User Name</label>
                      <input required type="text" className=' border-b-2 outline-none px-2 my-2 focus:border-gray-500' name='username' placeholder='Your user name' onChange={getdata} />
                  </div>
                  <div className='flex flex-col mt-4'>
                      <label htmlFor="email" className=' font-semibold text-lg'>Email</label>
                      <input required type="email" className=' border-b-2 outline-none px-2 my-2 focus:border-gray-500' name='email' placeholder='Your email id' onChange={getdata} />
                  </div>
                  <div className='flex flex-col mt-4'>
                      <label htmlFor="contact" className=' font-semibold text-lg'>Contact No. </label>
                      <input required type="text" className=' border-b-2 outline-none px-2 my-2 focus:border-gray-500' name='contact' placeholder='Your contact' onChange={getdata} />
                  </div>
                  <div className='flex flex-col mt-4'>
                  ...
                  <div className='mt-3'>
                      <h1 className=' text-center text-sm'>Already have an account <Link to={"/"} className='underline'>Login</Link> </h1>
                  </div>
